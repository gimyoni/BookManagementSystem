...
public class LogIn extends JFrame { 
	...
	public LogIn() {
		...
		JLabel lblId = new JLabel("ID"); //ID Label
		...
		JButton btnNewButton = new JButton("Log In"); //LogIn Button
		...
		JButton btnNewButton_1 = new JButton("Join Us"); //Join Us Button
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				EventQueue.invokeLater(new Runnable() {
					public void run() {
						try {	//Join Us 버튼을 누르면 
							Join frame = new Join(); //회원가입 창으로 이동
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				EventQueue.invokeLater(new Runnable() {
					public void run() {
						try { //회원탈퇴 버튼을 누르면
							DeleteUser frame = new DeleteUser(); //회원 탈퇴 창으로 이동
							frame.setVisible(true);
